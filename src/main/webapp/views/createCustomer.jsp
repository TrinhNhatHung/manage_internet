...
<div>
	...
	<form action="${pageContext.request.contextPath}/createCustomer" method="post" class="border" id="createCustomer" >
		<p class="form-header pl-3 pr-3 mb-3">Tạo tài khoản cho khách hàng</p>
